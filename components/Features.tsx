...
import { ArrowUpRight } from "lucide-react"; // ✅ replacing TiLocationArrow
...
export const BentoCardImage = ({ src, title, description }: BentoCardImageProps) => {
  return (
  ...
  <section className="bg-black pb-52">
    <div className="container mx-auto px-3 md:px-10">
      <div className="px-5 py-32">
        <p className="font-circular-web text-lg text-blue-50">Welcome to MindCare</p>
        <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">
          Discover features designed to enhance your mental well-being, bringing relaxation,
          engagement, and personalized support into your daily life.
        </p>
      </div>
          ...
          <a href="/face-detection">
            <div className="flex size-full flex-col justify-between bg-violet-300 p-5">
              ...
              <p className="text-black">
                Gamify your emotional well-being journey with mood tracking and calendar insights.
              </p>
              <ArrowUpRight className="m-5 scale-[5] self-end" />
            </div>
          </a>
        </BentoTilt>
